      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <p className="font-poppins text-lg font-bold text-muted-foreground mb-6 leading-relaxed">Ce receuille n'est pas là pour t'endormir il est là pour te réveiller.</p>
