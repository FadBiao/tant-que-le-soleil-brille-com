...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full bg-[hsl(var(--navbar-bg))] z-50 border-b border-white/20 h-14 md:h-16">
      <div className="container mx-auto px-4 h-full">
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="absolute top-full left-0 right-0 md:hidden bg-[hsl(var(--navbar-bg))] border-b border-white/20 animate-fade-in">
