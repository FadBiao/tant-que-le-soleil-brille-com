...
const Contact = () => {
  ...
  return <section id="contact" className="py-24 bg-gradient-dawn">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12 animate-fade-in">
          <Sun className="h-12 w-12 text-primary mx-auto mb-4 animate-float" />
          <h2 className="font-playfair text-4xl mb-4 mx-0 text-center font-medium text-slate-950 md:text-8xl">Contact</h2>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  field
                        ...
                        <FormControl>
                          <Input placeholder="Marie Dupont" maxLength={100} className="font-poppins" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>} />
                  ...
                  field
                        ...
                        <FormControl>
                          <Input type="email" placeholder="marie@exemple.com" maxLength={255} className="font-poppins" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>} />
                </div>
                ...
                field
                      ...
                      <FormControl>
                        <Textarea placeholder="Partagez votre lumière avec nous..." rows={6} maxLength={2000} className="font-poppins resize-none" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>} />

                <Button type="submit" size="lg" className="w-full bg-gradient-sun shadow-glow" disabled={form.formState.isSubmitting}>
